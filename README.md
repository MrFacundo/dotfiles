...
```sh
yay -S 7zip aichat bat bc bluez bluez-utils cava chromium clang cmake cmatrix cowsay docker docker-compose eza fastfetch fd ffmpeg fzf ghostty git github-cli glow gwenview kcolorchooser kdeconnect ktorrent less libreoffice-fresh man-db man-pages musescore ncdu neovim npm okular qt5-tools spectacle spotify-player starship stow syncthing tree unrar unzip vlc yazi zoxide zsh
```
